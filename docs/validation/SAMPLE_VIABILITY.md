...
| **2026-07-17 제헌절은 확정 휴장일이다** (2026-04-28 국무회의 의결, KRX 전 시장 휴장) | 확인 완료 (WO-FCE-VALIDATION-VERDICT-01 Phase 5) | 그날은 유실일이 아니라 비거래일이다 |
| 검증 창의 US(NYSE) 확정 휴장일은 없다 | `app/worker/market_calendar.py` | US 유실은 휴장 오계상이 아니다 |

> **정정**: WO-FCE-SAMPLE-VIABILITY-01 시점에는 "검증 창에 확정 KR 휴장일이 없다"고 적었다.
> 제헌절 재지정이 확인되면서 그 진술은 KR 에 대해 틀린 것이 됐고, 07-17은 이제 분모에서 빠진다.
>
> **영향 범위는 좁다**: KR 검증 시계는 첫 유효일(2026-07-22) 이후만 세므로 그보다 앞선
> 07-17이 빠져도 **유효 관측일·유실일 수치는 바뀌지 않는다.** 바뀌는 것은 창 전체 기준
> 커버리지 평균과 소급 리포트 표기다. 54.2%의 주된 원인은 여전히 다른 축에 있다.

아직 확인되지 않은 휴장 후보(설·추석·대체공휴일·지방선거일)는 **분모를 바꾸지 않은 채**
진단에 올라간다. 추정으로 유실일을 지우면 검증 진행도가 부풀려지므로, 확인될 때까지
나쁜 숫자를 그대로 둔다.
