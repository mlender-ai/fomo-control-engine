...
## 재기동 전 사전 점검 — 절전 (WO-FCE-DEFAULTS-01 4-3)

**재기동 전에 이것부터 확인한다.** 절전이 켜져 있으면 재기동해도 관측이 다시 끊긴다.
...
전원 연결 유지가 함께 필요하다. 배터리 모드에서는 `caffeinate` 도 일부 절전을 막지 못한다.

### 왜 사전 점검인가

유실일은 **되돌릴 수 없다.** 28일 창에서 하루 잃으면 유효일 상한이 하루 내려가고 그것은
