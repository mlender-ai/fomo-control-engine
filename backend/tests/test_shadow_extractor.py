...
def test_shadow_rule_extraction() -> None:
    trades = [
        Trade(position_id=f"00000000-0000-0000-0000-00000000000{i % 10}", symbol="BTCUSDT", direction=Direction.long, entry_price=100, exit_price=110, quantity=1, pnl_percent=5, pnl_amount=5, entry_score=80, exit_score=82, holding_minutes=60, exit_reason="test", review_text="")
        for i in range(10)
    ]
