...
def _analysis(mark: float, support=None, resistance=None, invalidation=None, funding=0.0, volume_state="balanced_flow", alignment="neutral"):
    return {
        "mark_price": mark,
        ...
        "volume_profile": {"poc_price": mark, "value_area_high": mark * 1.05, "value_area_low": mark * 0.95},
...
def test_survival_warning_when_stop_beyond_liquidation():
    ...
    analysis = _analysis(100.0, support=[{"price": 88.0, "score": 70, "label": "지지"}], resistance=[{"price": 110.0, "score": 70, "label": "저항"}])
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_survival_pass_when_stop_inside_liquidation():
    ...
    analysis = _analysis(100.0, support=[{"price": 96.0, "score": 70, "label": "지지"}], resistance=[{"price": 112.0, "score": 70, "label": "저항"}])
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_rr_ratio_and_usdt_amounts():
    ...
    analysis = _analysis(100.0, support=[{"price": 96.0, "score": 70, "label": "지지"}], resistance=[{"price": 108.0, "score": 70, "label": "저항"}])
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_rr_fail_below_threshold():
    ...
    analysis = _analysis(100.0, support=[{"price": 92.0, "score": 70, "label": "지지"}], resistance=[{"price": 104.0, "score": 70, "label": "저항"}])
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=5, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_htf_conflict_checklist_fail():
    analysis = _analysis(100.0, support=[{"price": 96.0, "score": 70, "label": "지지"}], resistance=[{"price": 108.0, "score": 70, "label": "저항"}], alignment="conflicting")
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_funding_adverse_for_long():
    analysis = _analysis(100.0, support=[{"price": 96.0, "score": 70, "label": "지지"}], resistance=[{"price": 108.0, "score": 70, "label": "저항"}], funding=0.001)
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
...
def test_drying_up_volume_fails():
    analysis = _analysis(100.0, support=[{"price": 96.0, "score": 70, "label": "지지"}], resistance=[{"price": 108.0, "score": 70, "label": "저항"}], volume_state="drying_up")
    result = simulate_entry(symbol="BTCUSDT", direction="long", entry_price=100.0, leverage=10, margin_usdt=100, margin_mode="isolated", chart_analysis=analysis, mmr=None, direction_score=60)
