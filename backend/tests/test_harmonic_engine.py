...
def test_harmonic_engine_detects_textbook_bullish_gartley() -> None:
    ...
    result = detect_harmonic_patterns(
        candles,
        levels=_support_levels(104.3),
        volume_profile=_volume_profile(104.25),
        atr_multiplier=3.0,
    )
...
def test_harmonic_engine_detects_textbook_bullish_bat() -> None:
    ...
    result = detect_harmonic_patterns(
        candles,
        levels=_support_levels(102.3),
        volume_profile=_volume_profile(102.25),
        atr_multiplier=2.0,
    )
...
def test_harmonic_engine_rejects_ratio_miss_over_tolerance() -> None:
    ...
    result = detect_harmonic_patterns(
        candles,
        levels=_support_levels(110.0),
        volume_profile=_volume_profile(110.0),
        atr_multiplier=3.0,
    )
...
def test_harmonic_prz_flows_into_take_profit_action_plan() -> None:
    ...
    chart_analysis = _chart_analysis_payload(
        position,
        candles,
        levels=_resistance_levels(115.7),
        volume_profile=_volume_profile(115.75),
    )
