...
RULE_LABELS: dict[str, str] = {
    ...
    # WO-FCE-ENGINE-LIVENESS-01: 생존 감시 계열 — 뮤트를 관통한다(C2).
    "engine_liveness": "엔진 트랙 정지",
    "job_backoff_stuck": "잡 백오프 고착",
    "infra_capacity": "인프라 용량 경고",
    "process_restarted": "프로세스 재시작",
...
RULE_SEVERITY: dict[str, AlertSeverity] = {
    ...
    "wyckoff_event": "info",
    "data_stall": "warn",
    "engine_liveness": "critical",
    "job_backoff_stuck": "warn",
    "infra_capacity": "warn",
    "process_restarted": "warn",
